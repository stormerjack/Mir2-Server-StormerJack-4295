...
namespace Client.MirScenes.Dialogs
{
    public sealed class TrustMerchantDialog : MirImageControl
    {
        ...
        private readonly string consignmentText = $"1. 5% of sale price is paid to Trust Merchant " +
            $"at sale end\r\n\r\n2. Maximum {Globals.ConsignmentLength} days of item sale registration until item is removed\r\n\r\n3. Maximum of unlimited " +
            $"items allowed for sale\r\n\r\n4. Sale price can be set between: {Globals.MinConsignment} - {Globals.MaxConsignment} gold";
